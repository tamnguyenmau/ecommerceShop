...
namespace ECommerceShop.Areas.Admin.Controllers
{
    ...
    public class AdminCustomersController : Controller
    {
        ...
        public AdminCustomersController(DBContext context, INotyfService notifyService)
        {
            _context = context;
        ...
        public async Task<IActionResult> Create([Bind("CustomerId,FullName,BirthDay,Avatar,Address,Email,Phone,LocationId,District,Ward,CreateTime,Password,Salt,LastLogin,Status")] Customer customer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CustomerId,FullName,BirthDay,Avatar,Address,Email,Phone,LocationId,District,Ward,CreateTime,Password,Salt,LastLogin,Status")] Customer customer)
        {
